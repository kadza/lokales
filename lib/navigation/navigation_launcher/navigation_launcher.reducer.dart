...
final navigationLauncherReducer = combineReducers<NavigationLauncherState>([
  TypedReducer<NavigationLauncherState, LaunchNavigationAction>(
      _launchNavigation),
  TypedReducer<NavigationLauncherState, LaunchNavigationSuccessAction>(
      _launchNavigationSuccess),
  TypedReducer<NavigationLauncherState, LaunchNavigationFailureAction>(
      _launchNavigationFailure),
]);

NavigationLauncherState _launchNavigation(
    NavigationLauncherState state, LaunchNavigationAction action) {
...
NavigationLauncherState _launchNavigationSuccess(
    NavigationLauncherState state, LaunchNavigationSuccessAction action) {
  return NavigationLauncherState(
...
NavigationLauncherState _launchNavigationFailure(
    NavigationLauncherState state, LaunchNavigationFailureAction action) {
  return NavigationLauncherState(
      destinationLocation: state.destinationLocation,
