...
class AddMediaAction{
  ...
  factory AddMediaAction.fromJson(Map<String, dynamic> json) => _$AddMediaActionFromJson(json);
...
class ClearMediaAction{
  ...
  factory ClearMediaAction.fromJson(Map<String, dynamic> json) => _$ClearMediaActionFromJson(json);
