...
class CharacteristicsCardView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return DetailsCard(
      ...
      child: Column(
        children: characteristicList.map((characteristic) => 
          _getCharacteristics(
            characteristic, 
            context, 
  ...
  static Widget _getCharacteristics(
    ...
    final waterLevelIcon = characteristics.isWaterDeep ? 
      Lokales.deep_water : Lokales.shallow_water;

    final waveIcon = characteristics.isWaterFlat ?
      Lokales.flat : Lokales.waves;
